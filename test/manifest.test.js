...
test("manifest exposes the M3 tools, page, startup, UI picker, and SiliconFlow network host", () => {
  ...
  assert.deepEqual(manifest.contributes.tools.map((file) => path.basename(file)), [
    "kb-create.js", "kb-ingest.js", "kb-search.js", "kb-list.js", "kb-delete-doc.js", "kb-graph-build.js", "kb-graph-stats.js", "kb-update-config.js", "kb-delete-library.js", "kb-doc-list.js", "kb-graph-data.js", "kb-rebuild-library.js",
  ]);
